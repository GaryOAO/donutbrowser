...
interface CommandPaletteProps {
  ...
  /** Ordered list of groups for Mod+1..9. */
  groupTargets: GroupTarget[];
  onSelectGroup: (id: string) => void;
  /** All profiles for launch/stop entries. */
 ...
 * sorts higher. "ctest stop" matches "Stop ctest" — the default cmdk filter
...
export function CommandPalette({
  ...
  // Only the first 9 group targets have a Mod+digit binding. We still display
  // more in the palette (without a shortcut hint) so the user can search/jump
  // to any of them.
