...
export interface ShortcutDef {
  ...
  id: ShortcutId;
  /** Translation key for the displayed label in the shortcuts dialog / palette. */
  labelKey: string;
  group: ShortcutGroup;
...
/**
 * Render a shortcut as the platform-correct token list. The shortcuts dialog
 * and the command palette both consume this so the glyphs stay in sync.
 *
 * On macOS: ["⌘", "⇧", "⌥", "K"]
